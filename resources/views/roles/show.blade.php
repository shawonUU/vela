                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="name" class="form-control" type="text" placeholder="Enter name" value="{{ old('name', $role->name) }}" readonly>
                                </div>
                                <div class="form-group col-md-6" readonly>
                                    <label class="form-label">Permissions</label>
                                    <select name="permissions[]" multiple="multiple" id="permissions" class="form-group form-select" disabled>
