    ...
    <div class="container-fluid">
        <div class="row align-items-end g-3">
            ...
            <div class="col-md-2 col-12">
                ...
                <select id="customer_filter" name="customer_filter" class="form-select" onchange="updateDashboard()">
                    <option value="">Select Customer</option>
                    @foreach($customers_for_filter as $customer)
                    <option value="{{ $customer->id }}" {{ ($customer_filter == $customer->id?'selected':'') }}>{{ $customer->name }} - {{ $customer->mobile_no }}</option>
                    @endforeach
                </select>
            </div>
            <!-- Action Buttons -->
            <div class="col-md-3 mt-3 d-flex justify-content-end gap-2 flex-wrap">
                <a href="{{ route('customer.all.transaction') }}" class="btn btn-outline-dark">
                    <i class="fas fa-undo"></i> Reset
                </a>
                <a href="{{ route('customer.all.transaction-report-pdf',
        ...
        <div class="row" style="padding-top: 10px !important;">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">CUSTOMERS TRANSACTIONS</h4>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <span class="fw-bold">{{ $item['customer_name'] }}</span>
                                            <form action="{{ route('customer.report') }}" method="GET" target="_blank" class="mb-0">
                                                <input type="hidden" name="customer_id" value="{{ $item['customer_id'] }}">
                                                <button type="submit" class="btn btn-sm btn-link p-0" title="Customer Invoice Details">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('customer.due_payment.make_payment.edit', $item['transaction_id']) }}" class="btn btn-info btn-sm" title="Edit Transaction">
