...
<div class="page-content">
        ...
        <div class="row">
            <div class="col-sm-12 col-s-12">
                <div class="card">
                    ...
                    <form method="post" action="{{ route('purchase.store') }}" id="postForm" autocomplete="off">
                        @csrf
                        <div class="card-body pb-0">
                            <div class="row ">
                                ...
                                <div class="form-group col-md-9 pb-0">
                                    ...
                                    <select id="product_barcode" class="form-select">
                                        ...
                                        <option value="{{ $item->barcode }}">
                                            {{ $item['product']['name'] }}  {{ $item['size']->name ? " ({$item['size']->name})" : '' }}
                                ...
                                <div class="col-md-2 text-left">
                                    ...
                                    <input class="form-control" type="text" name="purchase_no" value="{{ $purchase_no }}" id="purchase_no" readonly style="background-color:#ddd; ">
                                </div>
                                <div class="col-md-4 text-left">
                                    <label for="example-text-input" class="col-form-label">Challan No.</label>
                                    <input class="form-control" type="text" name="wo_no" id="wo_no" placeholder="Enter Challan No.">
                                </div>
                                <div class="form-group col-md-4 pb-0">
                            ...
                            <div class="row new_supplier mb-0" style="display: none;">
                                ...
                                <div class="form-group col-md-12 mt-2">
                                    <textarea name="office_address" id="office_address" class="form-control" placeholder="Write office address here..."></textarea>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="purchase_tax_amount" id="invoice_tax_amount" class="form-control " value="0" hidden>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="form-group">
                                <button type="button" class="btn btn-warning previewBtn" data-value="0" data-action="saveButton" id="saveButton" disabled>
                                    <i class="fas fa-check-circle"></i> Draft
                                </button>
                                <button type="button" class="btn btn-primary previewBtn" data-value="1" data-action="saveButton" id="saveAndPrintButton" disabled>
                                    <i class="fas fa-check-circle"></i> Save & Purchase Print
                                </button>
                            </div>
                        </div> <!-- End card-body -->
                </div>
    ...
    <!-- Preview model start-->
    <div class="modal fade" id="purchasePreviewModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe id="purchasePreviewIframe" width="100%" height="600px" style="border:none;"></iframe>
                </div>
    ...
    <!-- Preview model end-->
    <!-- Product row insert in purchase -->
    <script id="document-template" type="text/x-handlebars-template">
        <tr class="delete_add_more_item" id="delete_add_more_item">
            ...
            <td>
                <input type="text" class="form-control product_buying_price text-right" name="product_buying_price[]" value="@{{product_buying_price}}" min="1" > 
                <input type="text" class="form-control unit_price text-right" name="unit_price[]" value="@{{product_price}}" hidden> 
            </td>
            <!-- <td colspan="2">
            ...
            button.addEventListener('click', function() {
                ...
                fetch("{{ route('purchase.preview') }}", {
                    ...
                    .then(blob => {
                        ...
                        document.getElementById('purchasePreviewIframe').src = url;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const saveAndPrintButton = document.getElementById('saveAndPrintButton');
            ...
            function toggleUI(selectedValue) {
                ...
                if (selectedValue === '0') {
                    newSupplierForm.style.display = 'flex'; // show new customer form
    ...
    <!-- New Supplier Insert form select New customer Option -->
    <script type="text/javascript">
