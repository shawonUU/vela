                        ...
                        <div class="col-12">
                            <div class="invoice-title" style="text-align: center;">
                                <div class="text-center mb-2" >
                                    ...
                                    <h3 class="com-name" style="font-size:30px;margin-bottom:-30px;"><strong>{{ $org->org_name_en??'N/A' }}</strong></h3> <br>
                                </div>
                                <h5 class="text-center font-size-10" style="margin-top:0px;">
                                    {{ $org->address??'N/A' }}<br>
