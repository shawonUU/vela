  ...
  <div class="container-fluid">
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <ol class="breadcrumb m-0">
              ...
              <li class="m-2 breadcrumb-item"><a href="{{route('customer.all.transaction')}}"> BACK </a></li>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <form action="{{route('customer.due_payment.make_payment.update')}}" method="POST" autocomplete="off">
              @csrf
              <input type="text" name="customer_id" id="customerId" value="{{$common['customer_id']}}" hidden>
              <input type="text" name="transaction_id" value="{{$common['transaction_id']}}" hidden>
              <div class="mb-3">
                <h4 id="customerName">{{ $payments[0]->customer->name }}</h4>
                <p>Mobile Number: {{$payments[0]->customer->mobile_no}}</p>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  <label for="invoice_type" class="form-label">Invoice</label>
                  <input type="text" class="form-control" name="invoice_type" id="invoice_type" value="{{$invoice_ids_string}}" readonly>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 mb-3">
              ...
              <div class="row">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <select name="status" class="form-select" id="">
                    ...
                    <option value="pending" {{ $common['status'] == 'pending'? 'selected':'' }}>Pending</option>
