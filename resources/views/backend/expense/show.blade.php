                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="article_id" id="article_id" class="form-control" required disabled>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="pay_to_user_id" class="form-control" disabled>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="amount" class="form-control" type="number" step="0.01" placeholder="Enter amount" value="{{ $expense->amount }}" required disabled>
                                    @error('amount')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <!-- Expense Method -->
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Expense Method </label>
                                <div class="col-sm-10">
                                    <select name="payment_method" class="form-control" required disabled>
                           ...
                           <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="date" class="form-control" type="date" value="{{ \Carbon\Carbon::parse($expense->date)->format('Y-m-d') }}" required disabled>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="note" class="form-control" placeholder="Optional note" disabled>{{ $expense->note }}</textarea>
                                    @error('note')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3 align-items-center">
                                ...
                                <div class="col-sm-10">
                                    <select name="is_approved" id="approval" class="form-select" disabled>
