...
use App\Http\Controllers\ExpenseArticleController;
...
Route::middleware(['business_day'])->group(function () {
    ...
    Route::middleware('auth')->group(function () {
       ...
       // Pay To User All Routes
        ...
        Route::controller(ExpenseArticleController::class)->group(function () {
            Route::get('/expenses-article/all', 'index')->name('expenses.article.index');
            Route::get('/expenses-article/create', 'create')->name('expenses.article.create');
            Route::post('/expenses-article', 'store')->name('expenses.article.store');
            Route::get('/expenses-article/{article}/edit', 'edit')->name('expenses.article.edit');
            Route::put('/expenses-article/{article}', 'update')->name('expenses.article.update');
            Route::get('/expenses-article/delete/{id}', 'destroy')->name('expenses.article.delete');
            Route::get('/expenses/get-articles/{category}', 'getArticles')->name('expenses.get_articles');
        });
        ...
        Route::controller(ProductController::class)->group(function () {
            ...
            Route::get('/product/download/excel', 'downloadExcel')->name('product.download_excel');
